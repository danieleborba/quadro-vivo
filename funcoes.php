...
<?php
    ...
    <div class="nav-wrapper">
      <a id="logo-container" href="index.php" class="brand-logo red-text" style="margin-left: 1em"><img src="img/logo/logo3.png" style="height: 3.5rem; width: 19.5rem; margin-top: .2rem"></a>
	...
	function gerarFooter() {
		echo '<footer class="page-footer red" style="padding: 2vh 5vw 0 8vw">
				<div class="row">
